...
public class ArrayStack<E>
{
	 ...
	 * @throws EmptyDeckException if the stack is empty
	 */
	public E pop() throws EmptyDeckException
	{
		if(isEmpty())
			throw new EmptyDeckException("The stack is empty");
	 ...
	 * @throws EmptyDeckException if the stack is empty
	 */    
	public E peek() throws EmptyDeckException
	{
		if(isEmpty())
			throw new EmptyDeckException("The stack is empty");
